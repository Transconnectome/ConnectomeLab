...
#----------------------------------------------------
#SBATCH -J Prs05          # Job name
#SBATCH -o Prs05.o%j       # Name of stdout output file
#SBATCH -e Prs05.e%j       # Name of stderr error file
...
cd $/work/07406/yoonbal/stampede2/PRSice2/DEPRESSION_SUB
module load Rstats
Rscript /work/07406/yoonbal/stampede2/PRSice2/PRSice.R \
--prsice /work/07406/yoonbal/stampede2/PRSice2/PRSice_linux \
--dir /work/07406/yoonbal/stampede2/PRSice2/DEPRESSION_SUB \
--base /work/07406/yoonbal/stampede2/ABCD_summarystats/CNCR_DEPRESSION_SUB_ver2.txt \
...
--thread 28 \
--out /work/07406/yoonbal/stampede2/PRSice2/DEPRESSION_SUB/DEPRESSION_SUB \
...
# cols in sumstat: CHR BP SNP RSID A1 A2 EAF MAF Z BETA SE P N INFO_UKB
#--beta BETA \
# --info 0.9 \
