...
#----------------------------------------------------
#SBATCH -J Prs04          # Job name
#SBATCH -o Prs04.o%j       # Name of stdout output file
#SBATCH -e Prs04.e%j       # Name of stderr error file
...
cd $/work/07406/yoonbal/stampede2/PRSice2/DEPRESSION
module load Rstats
Rscript /work/07406/yoonbal/stampede2/PRSice2/PRSice.R \
--prsice /work/07406/yoonbal/stampede2/PRSice2/PRSice_linux \
--dir /work/07406/yoonbal/stampede2/PRSice2/DEPRESSION \
--base /work/07406/yoonbal/stampede2/ABCD_summarystats/CNCR_DEPRESSION_ver3.txt \
...
--bar-levels 0.05,1 \
--thread 28 \
--out /work/07406/yoonbal/stampede2/PRSice2/DEPRESSION/DEPRESSION \
--cov /work/07406/yoonbal/stampede2/ABCD_genotype/ABCD_QCed_PRSice2_pca.eigenvec \
--cov-col @PC[1-10] \
--extract /work/07406/yoonbal/stampede2/PRSice2/DEPRESSION/DEPRESSION.valid \
--info 0.9 \
--beta
