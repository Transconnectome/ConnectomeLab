...
#----------------------------------------------------
#SBATCH -J Prs08          # Job name
#SBATCH -o Prs08.o%j       # Name of stdout output file
#SBATCH -e Prs08.e%j       # Name of stderr error file
...
cd $/work/07406/yoonbal/stampede2/PRSice2/INSOMNIA
module load Rstats
Rscript /work/07406/yoonbal/stampede2/PRSice2/PRSice.R \
--prsice /work/07406/yoonbal/stampede2/PRSice2/PRSice_linux \
--dir /work/07406/yoonbal/stampede2/PRSice2/INSOMNIA \
--base /work/07406/yoonbal/stampede2/ABCD_summarystats/ETC_INSOMNIA_ver2.txt \
...
--bar-levels 0.05,1 \
--thread 28 \
--out /work/07406/yoonbal/stampede2/PRSice2/INSOMNIA/INSOMNIA \
--cov /work/07406/yoonbal/stampede2/ABCD_genotype/ABCD_QCed_PRSice2_pca.eigenvec \
--cov-col @PC[1-10] \
--info 0.9
# --extract /work/07406/yoonbal/stampede2/PRSice2/INSOMNIA/iqout.valid
# cols in sumstat: CNR BP SNP UNIQUE_ID A1 A2 EAF MAF OR SE P N INFO
#--beta BETA \
# --info 0.9 \
