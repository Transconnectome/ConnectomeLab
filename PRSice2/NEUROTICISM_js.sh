...
#----------------------------------------------------
#SBATCH -J Prs03          # Job name
#SBATCH -o Prs03.o%j       # Name of stdout output file
#SBATCH -e Prs03.e%j       # Name of stderr error file
...
cd $/work/07406/yoonbal/stampede2/PRSice2/NEUROTICISM
module load Rstats
Rscript /work/07406/yoonbal/stampede2/PRSice2/PRSice.R \
--prsice /work/07406/yoonbal/stampede2/PRSice2/PRSice_linux \
--dir /work/07406/yoonbal/stampede2/PRSice2/NEUROTICISM \
--base /work/07406/yoonbal/stampede2/ABCD_summarystats/CNCR_NEUROTICISM_ver3.txt \
...
--model add \
--maf 0.01 \
--base-maf MAF_UKB:0.01 \
--fastscore \
--bar-levels 0.00000005,0.0000005,0.000005,0.00005,0.0005,0.005,0.05,1 \
--thread 28 \
--out /work/07406/yoonbal/stampede2/PRSice2/NEUROTICISM/NEUROTICISM \
--cov /work/07406/yoonbal/stampede2/ABCD_genotype/ABCD_QCed_PRSice2_pca.eigenvec \
--cov-col @PC[1-10] \
--extract /work/07406/yoonbal/stampede2/PRSice2/NEUROTICISM/NEUROTICISM.valid \
--beta
# cols in sumstat: CHR BP SNP RSID A1 A2 EAF_UKB MAF_UKB Z P N INFO_UKB
#--beta BETA \
# --info 0.9 \
# --extract /work/07406/yoonbal/stampede2/PRSice2/NEUROTICISM/NEUROTICISM.valid \